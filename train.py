...
@click.option('--augpipe',      help='Augmentation pipeline [default: bgc]',                    type=click.Choice(['blit', 'geom', 'color', 'filter', 'noise', 'cutout', 'bg', 'bgc', 'bgcf', 'bgcfn', 'bgcfnc', 'bcfc', 'bc', 'custom', 'noflip']))
...
@click.option('--snap-res',     help='Screen resolution to save image snapshot',                type=click.Choice(['one', 'qHD', '1080p', '4k', '8k']), default='4k', show_default=True)
